...
<body class="bg-gray-50 dark:bg-gray-900" x-cloak>
            ...
            <header class="flex items-center justify-between px-6 py-4 bg-white dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <div class="flex items-center space-x-6">
                    <div class="flex space-x-4">
                        ...
                        <!-- TikTok -->
                        <a href="https://tiktok.com/@chinchapiro" target="_blank" class="text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-gray-100">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <footer class="mt-8 pt-6 border-t dark:border-gray-700">
                    <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <div class="text-center md:text-left">
                            ...
                            <p class="dark:text-gray-300">काठमाडौं-३२, टिन्कुने<br>गैरिगाउ, चिञ्चा पिरो भवन</p>
                        </div>
    ...
    <a href="https://wa.me/9779846216711"
       ...
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
           <path fill="currentColor" d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91c0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21c5.46 0 9.91-4.45 9.91-9.91c0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0 0 12.04 2m.01 1.67c2.33 0 4.52.91 6.17 2.56a8.677 8.677 0 0 1 2.55 6.17c0 4.84-3.94 8.78-8.78 8.78c-1.48 0-2.93-.37-4.19-1.07l-.3-.15l-3.12.82l.83-3.04l-.18-.28c-.76-1.15-1.17-2.49-1.17-3.88c0-4.84 3.94-8.78 8.78-8.78M8.53 7.33c-.25 0-.43.01-.63.08c-.2.07-.35.16-.5.35c-.15.19-.54.6-.54 1.46c0 .85.44 1.69.85 2.24c.41.55.89 1 1.55 1.37c.67.36 1.41.57 2.2.64c.78.07 1.69.01 2.65-.67c.55-.4 1.01-.89 1.34-1.45c.33-.56.46-1.16.46-1.71c0-.25-.03-.48-.17-.67c-.14-.19-.35-.27-.6-.3c-.25-.03-.53-.02-.76.02c-.23.04-.45.1-.63.18c-.18.07-.37.06-.51-.02c-.14-.08-.34-.23-.52-.43c-.18-.2-.37-.43-.56-.6c-.2-.17-.4-.02-.5.08c-.1.1-.38.38-.47.5c-.1.13-.19.2-.35.3c-.16.1-.34.15-.52.2c-.18.05-.37.01-.51-.07c-.14-.08-.28-.23-.4-.43c-.12-.2-.25-.5-.34-.75c-.09-.25-.1-.46-.1-.64c0-.2.02-.37.06-.5c.04-.13.05-.2.05-.27c0-.07-.03-.12-.08-.17c-.05-.05-.11-.06-.2-.06"/>
       </svg>
    </a>
